...
public class HttpServer {
	...
	public static Response resolve()throws AppException{
	...
	public static InputStream requestServer(Map<String, String> requestHeader,String requestContent) throws AppException {
		try {
